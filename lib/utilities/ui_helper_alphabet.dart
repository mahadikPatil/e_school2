...
class UIHelperAlphabet extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperAlphabet> createState() => _UIHelperAlphabetState();
}

class _UIHelperAlphabetState extends State<UIHelperAlphabet> {
