...
class UIHelperAnimal extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperAnimal> createState() => _UIHelperAnimalState();
}

class _UIHelperAnimalState extends State<UIHelperAnimal> {
