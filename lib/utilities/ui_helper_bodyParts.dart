...
class UIHelperBodyParts extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperBodyParts> createState() => _UIHelperBodyPartsState();
}

class _UIHelperBodyPartsState extends State<UIHelperBodyParts> {
