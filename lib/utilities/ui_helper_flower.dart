...
class UIHelperFlower extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperFlower> createState() => _UIHelperFlowerState();
}

class _UIHelperFlowerState extends State<UIHelperFlower> {
