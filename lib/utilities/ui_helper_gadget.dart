...
class UIHelperGadget extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperGadget> createState() => _UIHelperGadgetState();
}

class _UIHelperGadgetState extends State<UIHelperGadget> {
