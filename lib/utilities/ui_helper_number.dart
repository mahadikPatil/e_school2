...
class UIHelperNumber extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperNumber> createState() => _UIHelperNumberState();
}

class _UIHelperNumberState extends State<UIHelperNumber> {
