...
class UIHelperPetAnimal extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperPetAnimal> createState() => _UIHelperPetAnimalState();
}

class _UIHelperPetAnimalState extends State<UIHelperPetAnimal> {
