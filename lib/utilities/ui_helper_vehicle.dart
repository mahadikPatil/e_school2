...
class UIHelperVehicle extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperVehicle> createState() => _UIHelperVehicleState();
}

class _UIHelperVehicleState extends State<UIHelperVehicle> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                //   widthFactor: 1.0, // Set the width factor to 1.0 for full width
                //   child: AspectRatio(
                //     aspectRatio: 16 / 9, // Replace with the actual aspect ratio you want
                //     child: Image.asset(
                //       widget.imgUrl,
                //       fit: BoxFit.fill,
                //     ),
