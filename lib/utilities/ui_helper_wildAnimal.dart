...
class UIHelperWildAnimal extends StatefulWidget {
  final String title;
  ...
  @override
  State<UIHelperWildAnimal> createState() => _UIHelperWildAnimalState();
}

class _UIHelperWildAnimalState extends State<UIHelperWildAnimal> {
